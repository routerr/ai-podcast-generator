...
const deleteDatabase = (): Promise<void> =>
  new Promise<void>((resolve, reject) => {
    ...
    deleteRequest.onblocked = () => reject(new Error('IndexedDB delete was blocked by an open connection.'));
  });
...
export const podcastStorageService = {
  ...
  async reset(): Promise<void> {
    ...
    try {
      ...
      console.warn('IndexedDB delete failed; falling back to clearing latest record only.', deleteError);
      await this.clear();
    }
  }
};
